...
public partial class sellerreg : System.Web.UI.Page
{
    ...
    {
        dbcon.Open();
        SqlCommand cmd = new SqlCommand("Insert into seller" + "([First_Name],[Last_Name],[Contact_no],[Email_Id],[Password],[Address],[Tv],[Grandmother],[Edecutation]) values (@First_Name,@Last_Name,@Contact_no,@Email_Id,@Password,@Address,@Tv,@Grandmother,@Edecutation)", dbcon);
        ...
        Response.Redirect("Sellerprodadd.aspx");  //(main code hia ye)
    }
}