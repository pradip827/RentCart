<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="wbuynow.aspx.cs" Inherits="wbuynow" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table border="1" class="auto-style2">
       ...
       <center> <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Place Order" Width="125px" Height="38px" /></center>
</asp:Content>
